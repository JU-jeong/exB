...
List searchedProducts = (List) request.getAttribute("searchedProducts");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<form action="UserController?action=searchProduct" method="post">
		<label font-size : 20pt> 商品名</label> <input type="text"
			name="searchProduct"> <input type="submit" value="検索">
	</form>
	<br>
	<br>
	<table border="1";  border-collapse = "collapse"; align="center"; width="100%">
		<tr align="center">
			<th>商品コード</th>
			<th>商品名</th>
			<th>単価</th>
		...
		<%for( int i = 0; i < searchedProducts.size(); i++ ) {
		    UserVO userVO = (UserVO)searchedProducts.get(i);
		%>
